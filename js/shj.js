...
var p = (t, e) => {
    for (var s in e) Xt(t, s, { get: e[s], enumerable: !0 });
};
var P = {};
p(P, { default: () => Wt });
var Wt,
...
var qt,
    Y = a(() => {
        qt = [{ expand: "strDouble" }, { type: "oper", match: /,/g }];
    });
var Z = {};
p(Z, { default: () => I });
var I,
...
var ae,
    et = a(() => {
        ...
        ae = [
            ...
            {
                match: RegExp(`<style${l}>((?!</style>)[^])*</style\\s*>`, "g"),
                sub: [
                    { match: RegExp(`^<style${l}>`, "g"), sub: o.sub },
                    {
            ...
            {
                match: RegExp(
                    `<script${l}>((?!<\/script>)[^])*<\/script\\s*>`,
                    "g"
                ),
                sub: [
                    { match: RegExp(`^<script${l}>`, "g"), sub: o.sub },
                    {
                        match: RegExp(
                            `${o.match}|[^]*(?=<\/script\\s*>$)`,
                            "g"
    ...
    d = a(() => {
        (pe = [
            ...
            [
                "make",
                [
                    /\b(ifneq|endif|if|elif|then|fi|echo|.PHONY|^[a-z]+ ?:$)\b|\$/gm,
                    10,
                ],
            ],
            ...
            (u = (t) =>
                pe
                    .map(([e, ...s]) => [
                        e,
                        s.reduce(
                            (c, [m, n]) => c + [...t.matchAll(m)].length * n,
                            0
                        ),
                    ])
                    .filter(([e, s]) => s > 20)
                    .sort((e, s) => s[1] - e[1])[0]?.[0] || "plain");
    });
var at = {};
p(at, { default: () => se });
var se,
...
var Se = w({
    ...
    "./languages/bash.js": () => Promise.resolve().then(() => (f(), $)),
    "./languages/bf.js": () => Promise.resolve().then(() => (B(), v)),
    "./languages/c.js": () => Promise.resolve().then(() => (H(), G)),
    "./languages/css.js": () => Promise.resolve().then(() => (z(), k)),
    "./languages/csv.js": () => Promise.resolve().then(() => (Y(), _)),
    ...
    "./languages/http.js": () => Promise.resolve().then(() => (pt(), at)),
    "./languages/ini.js": () => Promise.resolve().then(() => (ct(), st)),
    "./languages/java.js": () => Promise.resolve().then(() => (mt(), nt)),
    "./languages/js.js": () => Promise.resolve().then(() => (L(), rt)),
    "./languages/js_template_literals.js": () =>
        Promise.resolve().then(() => (Et(), ot)),
    "./languages/jsdoc.js": () => Promise.resolve().then(() => (ht(), ut)),
    ...
    "./languages/uri.js": () => Promise.resolve().then(() => (zt(), kt)),
    "./languages/xml.js": () => Promise.resolve().then(() => (R(), J)),
    "./languages/yaml.js": () => Promise.resolve().then(() => (Yt(), _t)),
});
var b = {},
    Ce = (t = "") =>
        t
            ...
            .replaceAll?.("<", "&lt;")
            .replaceAll?.(">", "&gt;"),
    De = (t, e) => (e ? `<span class="shj-syn-${e}">${t}</span>` : t);
async function Zt(t, e, s) {
    try {
        let c,
            ...
            y =
                typeof e == "string"
                    ? await (b[e] ?? (b[e] = Se(`./languages/${e}.js`)))
                    : e,
            g = [...(typeof e == "string" ? y.default : e.sub)];
        console.log(y);
        for (; h < t.length; ) {
            for (n.index = null, c = g.length; c-- > 0; ) {
                if (
                    ((m = g[c].expand ? U[g[c].expand] : g[c]),
                    r[c] === void 0 || r[c].match.index < h)
                ) {
                    if (
                        ((m.match.lastIndex = h),
                        (i = m.match.exec(t)),
                    ...
                    r[c] = { match: i, lastIndex: m.match.lastIndex };
                }
                r[c].match[0] &&
                    (r[c].match.index <= n.index || n.index === null) &&
                    (n = {
                        part: m,
            ...
            s(t.slice(h, n.index), y.type),
                (h = n.end),
                n.part.sub
                    ? await Zt(
                          n.match,
                          typeof n.part.sub == "string"
                              ? n.part.sub
                              : typeof n.part.sub == "function"
                              ? n.part.sub(n.match)
                              : n.part,
                          s
                      )
                    : s(n.match, n.part.type);
        }
...
async function we(t, e, s = !0, c = {}) {
    let m = "";
    return (
        await Zt(t, e, (n, i) => (m += De(Ce(n), i))),
        s
...
async function Ue(t, e = t.className.match(/shj-lang-([\w-]+)/)?.[1], s, c) {
    let m = t.textContent;
    s ??
        (s = `${
            t.tagName == "CODE"
...
`).length < 2
        ...
        (t.dataset.lang = e),
        (t.className = `${[...t.classList]
            .filter((n) => !n.startsWith("shj-"))
            .join(" ")} shj-lang-${e} shj-${s}`),
        (t.innerHTML = await we(m, e, s == "multiline", c));
}
var Ke = async (t) =>
        Promise.all(
            Array.from(document.querySelectorAll('[class*="shj-lang-"]')).map(
                (e) => Ue(e, void 0, void 0, t)
            )
        ),
    Ve = (t, e) => {
        b[t] = e;
